...
<img src="https://s2.loli.net/2023/06/20/QmbhjERDSWKTt81.png" alt="image-20210803081955246" style="zoom:80%;" /> 
...
![image-20210803084742416](https://s2.loli.net/2023/06/20/KHiZGXMJ4rWw5Dy.png) 
...
![image-20210803123858691](https://s2.loli.net/2023/06/20/nY16NgCuU7LsaBE.png) 
...
![image-20210803124220869](https://s2.loli.net/2023/06/20/pQnx6Uk2CGL3PKA.png)  
...
<img src="https://s2.loli.net/2023/06/20/bXrQd7liyhzkTHN.png" alt="image-20210803125619732" style="zoom:80%;" /> 



在上述的浏览器抓取的网络请求中，上传文件的调用url，在哪里配置的呢，这个时候，我们需要去看一下前端上传组件。

<img src="https://s2.loli.net/2023/06/20/mAECRQSt1JByhMX.png" alt="image-20210803125942295" style="zoom:80%;" /> 

虽然上述是ElementUI封装的代码，但是实际上最终还通过file域上传文件，如果未指定上传文件的参数名，默认为file。

<img src="https://s2.loli.net/2023/06/20/WrQbkzBFu5V9Yt6.png" alt="image-20210803130455590" style="zoom:80%;" /> 
...
所在包: com.togogo.reggie.controller
...
<img src="https://s2.loli.net/2023/06/20/F6gnTzJSKDNAeVM.png" alt="image-20210803232054156" style="zoom:80%;" /> 

而这样的话，就要求我们在测试时，每一次都需要先登录，登录完成后在进行图片上传的测试，为了简化我们的测试，我们可以在 LoginCheckFilter 的doFilter方法中，在不需要处理的请求路径的数组中再加入请求路径 /common/** , 如下: 

<img src="https://s2.loli.net/2023/06/20/5IcQqlYpn7T6PJx.png" alt="image-20210803232433983" style="zoom:80%;" /> 
...
![image-20210805160234154](https://s2.loli.net/2023/06/20/P7hFcwmrdDuGzKj.png) 
...
![image-20210803224818828](https://s2.loli.net/2023/06/20/eKJoZHV2r8yCf6g.png) 
...
<img src="https://s2.loli.net/2023/06/20/amReMgUntCr32lL.png" alt="image-20210803231134157"  /> 

通过F12查询页面发起的请求及响应的数据：

![image-20210803231302464](https://s2.loli.net/2023/06/20/AU1XxItlE9gonsz.png) 
...
![image-20210803234122966](https://s2.loli.net/2023/06/20/VhkN4SXDWyGETI9.png) 



### 2.2 数据模型

<img src="https://s2.loli.net/2023/06/20/fOApEV5yoexgzsF.png" alt="image-20210803235329340" style="zoom:80%;" /> 
...
<img src="https://s2.loli.net/2023/06/20/MFkWatincmfBGEy.png" alt="image-20210803235459347" style="zoom:80%;" /> 



**2). 菜品口味表:dish_flavor**

<img src="https://s2.loli.net/2023/06/20/P8VJx4k65hqNurv.png" alt="image-20210803235749393" style="zoom:80%;" /> 
...
![image-20210804003343531](https://s2.loli.net/2023/06/20/EcT5bpjAItXqg93.png) 
...
<img src="https://s2.loli.net/2023/06/20/YHJio6Z78de2U9f.png" alt="image-20210804003752632" style="zoom:80%;" /> 
...
<img src="https://s2.loli.net/2023/06/20/eg5Lrt6OZjiBdlX.png" alt="image-20210804004529310" style="zoom:80%;" /> 

浏览器抓取请求:

<img src="https://s2.loli.net/2023/06/20/X5wM4SVeRcvKD92.png" alt="image-20210804005030527" style="zoom:80%;" /> 
...
<img src="https://s2.loli.net/2023/06/20/IhGKgrRoewZyaj6.png" alt="image-20210804180408584" style="zoom:80%;" /> 
...
<img src="https://s2.loli.net/2023/06/20/mWz6hScoxFC4aKY.png" alt="image-20210804174956706" style="zoom:80%;" /> 

debug跟踪数据的封装情况: 

![image-20210804175034622](https://s2.loli.net/2023/06/20/OKUBLqnHzRlpwM1.png) 



然后在测试完毕后, 我们可以检查一下数据库中的数据保存情况:

![image-20210804175658010](https://s2.loli.net/2023/06/20/yHmF9Z4h8Ojwevf.png) 
...
<img src="https://s2.loli.net/2023/06/20/bQDmJkcsFKdGVR1.png" alt="image-20210804223703893" style="zoom:80%;" /> 
...
![image-20210804224842336](https://s2.loli.net/2023/06/20/QmfK6Hd4oszuM5A.png) 

<img src="https://s2.loli.net/2023/06/20/oK3SeEwxbA2G5BP.png" alt="image-20210804225259854" style="zoom:94%;" /> 
...
![image-20210805100944028](https://s2.loli.net/2023/06/20/bWV9Gz16ngLm3ih.png) 
...
<img src="https://s2.loli.net/2023/06/20/oiKLZTqPHsyblrD.png" alt="image-20210804232447587" style="zoom:80%;" /> 
...
<img src="https://s2.loli.net/2023/06/20/gdOP3Tbr8exMW9Q.png" alt="image-20210804233459252" style="zoom:80%;" /> 
...
<img src="https://s2.loli.net/2023/06/20/NTJK1IpaFPDqmlr.png" alt="image-20210804234104633" style="zoom:80%;" /> 



4). 页面发送请求，请求服务端进行图片下载，用于页图片回显(**已实现**)

![image-20210804234226201](https://s2.loli.net/2023/06/20/dXBbomnNhSFGZTD.png) 



5). 点击保存按钮，页面发送ajax请求，将修改后的菜品相关数据以json形式提交到服务端

<img src="https://s2.loli.net/2023/06/20/XkfUSBtqJhnrAOF.png" alt="image-20210804234442923" style="zoom:80%;" /> 
...
![image-20210805101812209](https://s2.loli.net/2023/06/20/BkTFJOU1RGvmuZa.png) 
