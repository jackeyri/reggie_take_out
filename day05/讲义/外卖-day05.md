...
<img src="https://s2.loli.net/2023/06/20/NlqPITYoQUA1M6r.png" alt="image-20210805232711418" style="zoom:80%;" /> 
...
![image-20210805233615067](https://s2.loli.net/2023/06/20/AGuJm4bUipfWXKI.png) 

在该表中，套餐名称name字段是不允许重复的，在建表时，已经创建了唯一索引。

![image-20210805234059563](https://s2.loli.net/2023/06/20/vDg2CE6xpor7ULN.png) 



**2). 套餐菜品关系表setmeal_dish**

![image-20210805233807009](https://s2.loli.net/2023/06/20/ZX6rkRNKaHyw2vQ.png) 
...
import com.togogo.reggie.entity.SetmealDish;
import com.togogo.reggie.mapper.SetmealDishMapper;
import com.togogo.reggie.service.SetmealDishService;
...
![image-20210806002144537](https://s2.loli.net/2023/06/20/xSv658tUCVQmHqX.png) 
...
![image-20210806002730820](https://s2.loli.net/2023/06/20/v1MibfSqFHmxj28.png) 

本次查询分类列表，传递的type为1，表示需要查询的是菜品的分类。查询菜品分类的目的，是添加套餐关联的菜品时，我们需要根据菜品分类，来过滤查询菜品信息。查询菜品分类列表的代码已经实现， 具体展示效果如下： 

![image-20210806003318531](https://s2.loli.net/2023/06/20/ig5TUclvYNwStfx.png)  



3). 当点击添加菜品窗口左侧菜单的某一个分类, 页面发送ajax请求，请求服务端，根据菜品分类查询对应的**菜品**数据并展示到添加菜品窗口中

![image-20210806004116496](https://s2.loli.net/2023/06/20/MUanIbg8ZKVtuJ9.png) 
...
![image-20210806004434277](https://s2.loli.net/2023/06/20/igbBWxyXS6N8t1k.png) 



6). 点击保存按钮，发送ajax请求，将**套餐**相关数据以json形式提交到服务端

![image-20210806005028874](https://s2.loli.net/2023/06/20/PQhmTZfkLj1WeUl.png) 
...
![image-20210806012153982](https://s2.loli.net/2023/06/20/XcR1Fi3maGKkAYS.png) 
...
![image-20210806014328575](https://s2.loli.net/2023/06/20/C7QWx5IPGguM4bl.png) 

debug跟踪数据封装:

![image-20210806014508310](https://s2.loli.net/2023/06/20/xchEsyab52HPnU1.png) 

跟踪数据库保存的数据:

![image-20210806014807017](https://s2.loli.net/2023/06/20/ZNlBDaF3JeE7tCI.png) 
...
![image-20210806073710653](https://s2.loli.net/2023/06/20/PmBwKucEvajkgs6.png) 
...
<img src="https://s2.loli.net/2023/06/20/fR5BrHITZczpEXt.png" alt="image-20210806074846550" style="zoom:80%;" /> 



2). 在列表渲染展示时，页面发送请求，请求服务端进行图片下载，用于页面图片展示(**已实现**)

![image-20210806075231072](https://s2.loli.net/2023/06/20/Ntwo4PaQCKd9igH.png) 
...
![image-20210806082542473](https://s2.loli.net/2023/06/20/ntKYpk9ejDUdmAz.png) 
...
![image-20210806083346578](https://s2.loli.net/2023/06/20/9F6QEeIdyJ21Vfk.png) 
...
![image-20210806214443507](https://s2.loli.net/2023/06/20/vbfYGmUWhyax5ON.png) 
...
![image-20210806215911878](https://s2.loli.net/2023/06/20/UwDOnMsBIrWloyt.png) 



2). 删除多个套餐时，页面发送ajax请求，根据提交的多个套餐id删除对应套餐

![image-20210806220406587](https://s2.loli.net/2023/06/20/xT6HBRwmKdXlDb8.png) 
...
![image-20210806221603303](https://s2.loli.net/2023/06/20/ti7GORALkswlhmJ.png) 
...
![image-20210806224121877](https://s2.loli.net/2023/06/20/C3DHienzmoWhV41.png) 
...
![image-20210806224603405](https://s2.loli.net/2023/06/20/KU3CY865NoGnEVr.png) 



3). 删除已经停售的套餐信息，执行删除之后， 检查数据库表结构 setmeal ， setmeal_dish表中的数据

![image-20210806224807108](https://s2.loli.net/2023/06/20/glA8uehRSoDGMVc.png) 
...
<img src="https://s2.loli.net/2023/06/20/SyfoHdPAv1QtmBn.png" alt="image-20210806225505074" style="zoom:80%;" /> 
...
![image-20210806231422923](https://s2.loli.net/2023/06/20/svjaDCTH5gIuNmf.png) 
...
![image-20210806231821334](https://s2.loli.net/2023/06/20/8udiq9KkTPUC2m5.png)  
...
<img src="https://s2.loli.net/2023/06/20/NMqngoLd6lxVYzs.png" alt="image-20210807074911618" style="zoom:80%;" /> 

点击官网首页注册按钮，跳转到如下注册页面：

<img src="https://s2.loli.net/2023/06/20/HPBdeytkx6pZimQ.png" alt="image-20210807074934251" style="zoom:80%;" /> 
...
![image-20210807075321250](https://s2.loli.net/2023/06/20/CohMNQxPwqZY3dX.png) 

<img src="https://s2.loli.net/2023/06/20/AGa5Fh7Ri8eHuVX.png" alt="image-20210807075620990" style="zoom:80%;" /> 
...
![image-20210807080406104](https://s2.loli.net/2023/06/20/2FeVdGDlWsmca4j.png) 
...
<img src="https://s2.loli.net/2023/06/20/U9GwKFlxEpeHujc.png" alt="image-20210807080659337" style="zoom:80%;" /> 



那么接下来，我们就需要来添加短信签名。

![image-20210807081839908](https://s2.loli.net/2023/06/20/YvGOP14ILZR8xFJ.png) 
...
![image-20210807082453655](https://s2.loli.net/2023/06/20/oPI2ywcQz1q3jJF.png) 
...
<img src="https://s2.loli.net/2023/06/20/LqFH5ka4rfNXxpi.png" alt="image-20210807082639900" style="zoom: 80%;" /> 
...
<img src="https://s2.loli.net/2023/06/20/p8u3xdaVowCEgym.png" alt="image-20210807083306928" style="zoom:80%;" /> 
...
![image-20210807130218414](https://s2.loli.net/2023/06/20/yPzThoVc6UCx15b.png)
...
![image-20210807131340003](https://s2.loli.net/2023/06/20/IZzRmg7ayFYoDST.png) 
...
![image-20210807183735533](https://s2.loli.net/2023/06/20/EX24jOxgtRVD3vn.png) 
...
![image-20210807190005367](https://s2.loli.net/2023/06/20/orSIAVfB4nqsE1v.png) 

然后再创建一个新的AccessKey, 保存好AccessKeyId和AccessKeySecret。

![image-20210807190304136](https://s2.loli.net/2023/06/20/gGLh9jlPFaINy15.png) 
...
![image-20210807193047220](https://s2.loli.net/2023/06/20/oBIStPik2RpL4jz.png) 

我们根据官方文档的提示，引入对应的依赖，然后再引入对应的java代码，就可以发送消息了。

![image-20210807193829131](https://s2.loli.net/2023/06/20/cJAouQR76tE9fgr.png) 
...
<img src="https://s2.loli.net/2023/06/20/GeYFWIPAw7nrhMN.png" alt="image-20210807232653592" style="zoom:80%;" />  
...
![image-20210807231948412](https://s2.loli.net/2023/06/20/dIYc4hCJv5aZxAU.png) 
...
<img src="https://s2.loli.net/2023/06/20/29WBRIiYa75TOp8.png" alt="image-20210807233018171" style="zoom:80%;" /> 



2). 在登录页面输入验证码，点击【登录】按钮，发送ajax请求，在服务端处理登录请求。

<img src="https://s2.loli.net/2023/06/20/ZlEwAX3y9k6oNx4.png" alt="image-20210807233336029" style="zoom:80%;" /> 
...
所属包: com.togogo.reggie.utils

![image-20210807234828051](https://s2.loli.net/2023/06/20/ufbjVSARgHnMpaQ.png) 
...
![image-20210807235349089](https://s2.loli.net/2023/06/20/cyYhGN1MmU5XCu8.png) 
...
<img src="https://s2.loli.net/2023/06/20/Xaxv5ctEP4ClDnB.png" alt="image-20210808001952043" style="zoom:80%;" /> 



2). 测试正确验证码的情况

![image-20210808002356092](https://s2.loli.net/2023/06/20/hkIpFDv62GOSWn3.png) 

检查user表，用户的数据也插入进来了： 

![image-20210808002501618](https://s2.loli.net/2023/06/20/Sr5ET4yLqKaZYxt.png) 
